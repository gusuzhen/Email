...
package cn.suishen.email.service;
...
import cn.suishen.email.SecurityPolicy;
...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    /**
     * Entry point for {@link cn.suishen.email.SecurityPolicy.PolicyAdmin}.  These will
     * simply callback to {@link
     * cn.suishen.email.SecurityPolicy#onDeviceAdminReceiverMessage(Context, int)}.
     */
